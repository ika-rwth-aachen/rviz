...
#include "rviz_default_plugins/displays/geofence/geofence_display.hpp"
...
PLUGINLIB_EXPORT_CLASS(rviz_default_plugins::displays::GeofenceDisplay, rviz_common::Display)
